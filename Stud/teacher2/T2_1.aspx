<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T2_1.aspx.cs" Inherits="Stud.teacher2.T2_1" %>
            ...
            <table align="center" class="table" style="margin-top: 20px;">
                <tr>
                    <td colspan="2" align="center">
                        <h3 style="margin: 0px; padding: 0px;">学生专业课表现</h3>
                        <p style="margin: 0px; padding: 0px;">&nbsp;</p>
                    </td>
                </tr>
                <tr>
                    <td class="td3">专业课名称：</td>
                    <td class="td4">
