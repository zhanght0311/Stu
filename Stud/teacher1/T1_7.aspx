<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T1_7.aspx.cs" Inherits="Stud.teacher1.T1_7" %>
     ...
     <table align="center" style="border: 0px solid #C0C0C0; font-family: 微软雅黑; font-size: 14px; color: #464646; position: inherit;">
            <tr>
                <td style="width: 456px; height: 40px; text-align: center ">
                    <strong><span style="font-size: 16pt;">管理所添加比赛</span></strong></td>
            </tr>
        </table>
   </div>
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="操作" Text="修改"
                    DataNavigateUrlFields="bianhao"
                     DataNavigateUrlFormatString="T1_7_1.aspx?bianhao={0}">
