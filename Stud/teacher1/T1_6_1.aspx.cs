...
{
    public partial class T1_6_1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string mysql = "select biaoti,xiangmujianjie,xiangmujiangxiang,Sno from Keyan where bianhao=" + bianhao;
        ...
        {
            string mysql;
            mysql = "delete from Keyan where bianhao=" + Session["test50"];
            if (mydb.ExecuteNonQuery(mysql))
            {

                mysql = "insert into Keyan values(" + Session["test50"] + ",'" + Tb_Addtime.Text + "','"
