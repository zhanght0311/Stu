<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S_10_1.aspx.cs" Inherits="Stud.students.S_10_1" %>
            ...
            <table align="center" class="table" style="margin-top: 20px;">
                <tr>
                    <td colspan="2" align="center">
                        <h3 style="margin: 0px; padding: 0px;">导员评价查看</h3>
                        <p style="margin: 0px; padding: 0px;">&nbsp;</p>
                    </td>
                </tr>
                <tr>
                    <td class="td3">专业名称：</td>
                    <td class="td4">
